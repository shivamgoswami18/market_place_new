                            ...
                            <TabPane eventKey={0} className="fade border-0 p-0 " id="switcher-home" role="tabpanel"
                                ...
                                <div className="">
                                    ...
                                    <Row className="row switcher-style gx-0 ">
                                        ...
                                        <Col  xl={3}  className=" col-6">
                                            <Form.Check className="form-check switch-select">
                                                <Form.Check.Label className="form-check-label" htmlFor="switcher-flat">
                                                    Flat
                                                </Form.Check.Label>
                                                <Form.Check.Input className="form-check-input" type="radio" name="page-styles" id="switcher-flat"
                                                     checked={variable.dataPageStyle === 'flat'}
                                                    defaultChecked
                                                    disabled={isLayoutLocked}
                                                    onChange={(_e) => { }}
                                                    onClick={() => setPageStyle('flat')}
                                                />
                                            </Form.Check>
                                        </Col>
                                    </Row>
                                ...
                                <div className="">
                                    ...
                                    <Row className="row switcher-style gx-0">
                                        <Col className="col-4">
                                            <Form.Check className="form-check switch-select">
                                                <Form.Check.Label className="form-check-label" htmlFor="switcher-default-width">
                                                    Default
                                                </Form.Check.Label>
                                                <Form.Check.Input className="form-check-input" type="radio" name="layout-width"
                                                    id="switcher-default-width"
                                                    checked={variable.dataWidth === 'default'}
                                                    disabled={isLayoutLocked}
                                                    onChange={(_e) => { }}
                            ...
                            <TabPane eventKey={1} className="fade border-0 p-0" id="switcher-profile" role="tabpanel"
                                ...
                                <div>
                                        ...
                                        <div className="d-flex switcher-style pb-2">
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Light Menu'>
                                                    <Form.Check.Input className="form-check-input color-input color-white" data-bs-toggle="tooltip"
                                            ...
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Dark Menu' >
                                                    <Form.Check.Input className="form-check-input color-input color-dark" data-bs-toggle="tooltip"
                                            ...
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Color Menu' >
                                                    <Form.Check.Input className="form-check-input color-input color-primary" data-bs-toggle="tooltip"
                                            ...
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Gradient Menu' >
                                                    <Form.Check.Input className="form-check-input color-input color-gradient" data-bs-toggle="tooltip" data-bs-placement="top" title="Gradient Menu" type="radio" name="menu-colors" id="switcher-menu-gradient" checked={variable.dataMenuStyles === 'gradient'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setMenuStyle('gradient')}/>
                                                </SpkTooltips>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Transparent Menu' >
                                                    <Form.Check.Input className="form-check-input color-input color-transparent" data-bs-toggle="tooltip" data-bs-placement="top" title="Transparent Menu" type="radio" name="menu-colors" id="switcher-menu-transparent" checked={variable.dataMenuStyles === 'transparent'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setMenuStyle('transparent')}/>
                                                </SpkTooltips>
                                            </Form.Check>
                                        </div>
                                        ...
                                        <div className="d-flex switcher-style pb-2">
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Light Header'>
                                                    <Form.Check.Input className="form-check-input color-input color-white" data-bs-toggle="tooltip" data-bs-placement="top"         title="Light Header" type="radio" name="header-colors" id="switcher-header-light" checked={variable.dataHeaderStyles === 'light'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setHeaderStyle('light')}/>
                                                </SpkTooltips>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Dark Header'>
                                                    <Form.Check.Input className="form-check-input color-input color-dark" data-bs-toggle="tooltip" data-bs-placement="top" title="Dark Header" type="radio" name="header-colors" id="switcher-header-dark" checked={variable.dataHeaderStyles === 'dark'}
                                                    disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setHeaderStyle('dark')}/>
                                                </SpkTooltips>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Color Header' >
                                                    <Form.Check.Input className="form-check-input color-input color-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Color Header" type="radio" name="header-colors" id="switcher-header-primary" checked={variable.dataHeaderStyles === 'color'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setHeaderStyle('color')}/>
                                                </SpkTooltips>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Gradient Header'>
                                                    <Form.Check.Input className="form-check-input color-input color-gradient" data-bs-toggle="tooltip" data-bs-placement="top" title="Gradient Header" type="radio" name="header-colors" id="switcher-header-gradient" checked={variable.dataHeaderStyles === 'gradient'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setHeaderStyle('gradient')}/>
                                                </SpkTooltips>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <SpkTooltips placement='top' title='Transparent Header' >
                                                    <Form.Check.Input className="form-check-input color-input color-transparent" data-bs-toggle="tooltip" data-bs-placement="top" title="Transparent Header" type="radio" name="header-colors" id="switcher-header-transparent" checked={variable.dataHeaderStyles === 'transparent'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setHeaderStyle('transparent')}/>
                                                </SpkTooltips>
                                            </Form.Check>
                                        </div>
                                        ...
                                        <div className="d-flex flex-wrap align-items-center switcher-style">
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-primary-1" type="radio" name="theme-primary" id="switcher-primary"
                                                 checked={variable.colorPrimaryRgb === ' 42 ,16, 164'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setPrimaryColor(' 42 ,16, 164')}/>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-primary-2" type="radio" name="theme-primary" id="switcher-primary1"
                                                 checked={variable.colorPrimaryRgb === '125 ,0, 189'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setPrimaryColor('125 ,0, 189')}/>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-primary-3" type="radio" name="theme-primary" id="switcher-primary2"
                                                 checked={variable.colorPrimaryRgb === '4, 118, 141'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setPrimaryColor('4, 118, 141')}/>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-primary-4" type="radio" name="theme-primary" id="switcher-primary3"
                                                 checked={variable.colorPrimaryRgb === '138, 0, 32'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setPrimaryColor('138, 0, 32')}/>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-primary-5" type="radio" name="theme-primary" id="switcher-primary4"
                                                 checked={variable.colorPrimaryRgb === '9 ,124, 103'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setPrimaryColor('9 ,124, 103')} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select ps-0 mt-1 color-primary-light">
                                                <div className="theme-container-primary">
                                                    <SpkButton Customclass="" Disabled={isLayoutLocked}>nano</SpkButton>
                                                </div>
                                                <div className="pickr-container-primary"  >
                                                    <div className='pickr'>
                                                        <SpkButton Customclass='pcr-button btn-primary' Disabled={isLayoutLocked} onClickfunc={!isLayoutLocked ? (ele: any) => {
                                    ...
                                    <div className="theme-colors">
                                        ...
                                        <div className="d-flex flex-wrap align-items-center switcher-style">
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-bg-1" type="radio" name="theme-background" id="switcher-background"
                                                 checked={variable.bodyBg === '0,8,52'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => updateBackgroundColor('0,8,52', ' 14,22,66','clicked')}/>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-bg-2" type="radio" name="theme-background" id="switcher-background1"
                                                checked={variable.bodyBg === '58, 0, 109'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => updateBackgroundColor('58, 0, 109', '72 ,14, 123','clicked')}/>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-bg-3" type="radio" name="theme-background" id="switcher-background2"
                                                checked={variable.bodyBg === '0 ,59, 70'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => updateBackgroundColor('0 ,59, 70', '14, 73, 84','clicked')}/>
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-bg-4" type="radio" name="theme-background" id="switcher-background3"
                                                    checked={variable.bodyBg === ' 65, 0, 0'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => updateBackgroundColor(' 65, 0, 0', '79 ,14, 14','clicked')} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select me-3">
                                                <Form.Check.Input className="form-check-input color-input color-bg-5" type="radio" name="theme-background" id="switcher-background4"
                                                    checked={variable.bodyBg === '1 ,77, 46'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => updateBackgroundColor('1 ,77, 46', '15 ,91, 60','clicked')} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select ps-0 mt-1 tooltip-static-demo color-bg-transparent">
                                                <div className="theme-container-background">
                                                    <SpkButton Disabled={isLayoutLocked}>nano</SpkButton>
                                                </div>
                                    ...
                                    <div className="menu-image mb-3">
                                        ...
                                        <div className="d-flex flex-wrap align-items-center switcher-style">
                                            ...
                                            <Form.Check.Input className="form-check-input bgimage-input bg-img1" type="radio" name="menu-background" id="switcher-bg-img" checked={variable.bgImg === 'bgimg1'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setBgImage(1)} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select m-2">
                                            <Form.Check.Input className="form-check-input bgimage-input bg-img2" type="radio" name="menu-background" id="switcher-bg-img1" checked={variable.bgImg === 'bgimg2'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setBgImage(2)} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select m-2">
                                            <Form.Check.Input className="form-check-input bgimage-input bg-img3" type="radio" name="menu-background" id="switcher-bg-img2" checked={variable.bgImg === 'bgimg3'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setBgImage(3)} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select m-2">
                                            <Form.Check.Input className="form-check-input bgimage-input bg-img4" type="radio" name="menu-background" id="switcher-bg-img3" checked={variable.bgImg === 'bgimg4'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setBgImage(4)} />
                                            </Form.Check>
                                            <Form.Check className="form-check switch-select m-2">
                                            <Form.Check.Input className="form-check-input bgimage-input bg-img5" type="radio" name="menu-background" id="switcher-bg-img4" checked={variable.bgImg === 'bgimg5'} disabled={isLayoutLocked} onChange={(_e) => { }} onClick={() => setBgImage(5)} />
                                            </Form.Check>
                                        </div>
                                    </div>
                                </div>
                            </TabPane>
                            <div className="d-flex justify-content-md-between justify-content-start canvas-footer flex-wrap gap-3 "> 
                                <Link to="#!" id="reset-all" className={`btn btn-danger w-100${isLayoutLocked ? ' disabled' : ''}`} aria-disabled={isLayoutLocked} tabIndex={isLayoutLocked ? -1 : undefined} onClick={isLayoutLocked ? undefined : Reset}>Reset</Link> 
                            </div>
