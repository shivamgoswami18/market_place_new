              ...
              <Card className="custom-card">
                ...
                <Card.Body className="pb-0 pt-5">
                  <div id="sales-overview">
                    <Spkapexcharts height={356} type={'line'} width={'100%'} chartOptions={Overviewoptions} chartSeries={Overviewseries} />
                  </div>
                </Card.Body>
                ...
                <Card.Body>
                  ...
                  <div className="d-flex align-items-center justify-content-between gap-3">
                    <div>
                      ...
                      <Link to="#!" className="btn btn-secondary btn-wave mt-1">Upgrade To Pro <i className="ti ti-arrow-narrow-right"></i></Link>
                    </div>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header className="justify-content-between">
                  ...
                  <Link to="#!" className="fs-12 text-muted text-decoration-underline">View Report <i className="ti ti-arrow-narrow-right"></i></Link>
                </Card.Header>
                <Card.Body className="pb-0 px-0">
                  <div id="visitors-report">
                    <Spkapexcharts height={290} type={'radar'} width={'100%'} chartOptions={Visitorsoptions} chartSeries={Visitorsseries} />
                  </div>
                </Card.Body>
              </Card>
            </Col>
        ...
        <Col xxl={3} md={6}>
          <Card className="custom-card overflow-hidden">
            <Card.Header className="justify-content-between">
              ...
              <Link to="#!" className="text-muted fs-12 text-decoration-underline">View All<i className="ti ti-arrow-narrow-right"></i></Link>
            </Card.Header>
                      ...
                      <td>
                        <div className="avatar-list-stacked text-end">
                          {order.avatars.map((avatar, i) => (
                            <span key={i} className="avatar avatar-rounded avatar-sm bg-light">
                              <Image src={avatar.src} alt={avatar.alt || "img"} />
                            </span>
                          ))}
                          {order.extraAvatars && (
                            <Link  className="avatar bg-primary avatar-rounded avatar-sm" to="#!">
                              +{order.extraAvatars}
                            </Link>
                          )}
                        </div>
