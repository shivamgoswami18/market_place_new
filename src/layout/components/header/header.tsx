...
const Header = () => {
  const [variable, _setVariable] = useState(getState());
  ...
  const menuClose = () => {
    ...
    if (window.innerWidth >= 992) {
      const localVaraiable = theme;
      const newToggledValue = localVaraiable.toggled ? localVaraiable.toggled : "";
    ...
    <div>
      <header className="app-header sticky" id="header">
        <div className="main-header-container container-fluid">
          {variable.toggled === "open" && <div ref={overlayRef} id="responsive-overlay" />}
                ...
                <ul className="list-unstyled mb-0">
                    ...
                    <ul className="list-unstyled mb-0 sub-list">
                      <li>
                        <Link className="dropdown-item d-flex align-items-center" to="#!">
                          <i className="ti ti-settings-cog me-2 fs-18" />
                          Profile Settings
                        </Link>
                      </li>
                    </ul>
                  ...
                  <li>
                    <Link
                      ...
                      to={`${import.meta.env.BASE_URL}sign-in`}
                    >
                      <i className="ti ti-logout me-2 fs-18" />
                      Log Out
                    </Link>
                  </li>
                </ul>
